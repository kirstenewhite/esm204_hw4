...
damages_qm <- lm(damages ~ 0 +  warming + warming2, data = damages)
...
```{r}
# Plot damages over time w/o pulse

# Plot damages over time w/ pulse 

# Plot the difference in damages over time that arise from the pulse

# Plot the the difference in damages over time from the pulse per ton of CO2
```
